    ...
    public class HorizontalScrollSnap : ScrollSnapBase, IEndDragHandler
    {
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (_scroll_rect.horizontal)
            {
                ...
                if (_startPosition.x - _screensContainer.localPosition.x > MinSwipeDistance)
                {
                    GoToScreen(_startPage + 1);
                }
                else if (_startPosition.x - _screensContainer.localPosition.x < -MinSwipeDistance)
                {
                    GoToScreen(_startPage - 1);
                }
